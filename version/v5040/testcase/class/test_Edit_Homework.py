...
class TestEditHomework:
    ...
    def test_enter_search_content(self, web_driver):
        LMSCoursePage().enter_search_content(web_driver, 'homework', 20)

    def test_click_hw_item(self, web_driver):
        LMSCoursePage().click_activities_item(web_driver)

    def test_switch_win_2(self, web_driver):
        get_new_page_special(web_driver, "/homework/detail?")

    def test_click_edit_enter(self, web_driver):
        LMSCoursePage().click_hw_edit_enter(web_driver)
    ...
    def test_click_hw_edit_closed(self, web_driver):
        LMSCoursePage().click_hw_page_closed(web_driver)
