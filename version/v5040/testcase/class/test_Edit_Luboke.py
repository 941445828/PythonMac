...
class TestEditLuboke:
    ...
    def test_enter_search_content(self, web_driver):
        LMSCoursePage().enter_search_content(web_driver, 'luboke', 20)

    def test_click_luboke_item(self, web_driver):
    ...
    def test_edit_luboke_close(self, web_driver):
        LMSCoursePage().click_luboke_page_closed(web_driver)

    def test_switch_win_5(self, web_driver):
        # get_new_page_special(web_driver, "&searchKey=luboke")
        get_new_page_special(web_driver, "course/list")
