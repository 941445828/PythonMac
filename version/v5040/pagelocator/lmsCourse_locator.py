...
UnitItem = ('单元主题item', 'XPath', "//p[@title='zjw_unit_topic_title_1681699498']")
AddBtn = ('添加+', 'XPath', "(//img[@class='auto-test-lms '])[last()]")


# 课程下 搜索
SearchLogo = ('搜索 放大镜logo', 'XPath', "(//img[@class='auto-test-lms'])[1]")
...
File_Yunpan = ('选择云盘的视频', 'XPaths', '//div[@id="cloudDiskTbody"]/div[1]')
LubokeEnsure = ('选择云盘的视频确定', 'XPath', '//span[contains(text(), "确定")]')
